...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/stylespintu.css">
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                        ...
                        <!-- se debe de cambiar ServletLibros -->
                                    <a href="ServletPinturas?instruccion=nuevo" 
                                       class="btn btn-info float-left mb-3">Nueva Pintura</a>
                    </div>
        ...
        <section class="centro">
            ...
            <div class="row">  
                <div class="col">
                    <h1 style="Color:white">Catálogo de Pinturas</h1>
                </div>
            </div>
        </div>
        ...
        <%
            //verificamos que existan las pinturas en la base de datos 
            if (lasPinturas.size() != 0) {//si existen las pinturas entramos a la tabla
        %>
        <div class="container">
            <table class="table table-striped">
                ...
                <tbody>
                    <%
                        for (Pintura pintura : lasPinturas) {
                            out.print("<tr>");
                            out.print("<td>" + pintura.getPint_id() + "</td>");
                            out.print("<td>" + pintura.getPint_nombre() + "</td>");
                            out.print("<td>" + pintura.getPint_fecha() + "</td>");
                            out.print("<td>" + pintura.getPint_valor() + "</td>");
                            out.print("<td>" + pintura.getPintor().getPin_nombre() + "</td>");
                            out.print("<td>" + pintura.getTecnica().getDescripcion() + "</td>");
                            //boton Modificar
                            out.print("<td><a class='btn btn-info' href='ServletPinturas?PINT_ID="
                                    + pintura.getPint_id() + "&instruccion=actualizar'>Modificar</a></td>");
                            //boton eliminar
                            out.print("<td><a class='btn btn-warning' style='color: black;' href='ServletPinturas?PINT_ID="
                                        + pintura.getPint_id() + "&instruccion=eliminar' onclick='confirmarEliminacion(event, \"" + pintura.getPint_nombre() + "\")'>Eliminar</a></td>");
                                out.print("</tr>");
        ...
        <%
                ...
                out.print("<h4>No hay Pinturas en la base de datos</h4>");
            }
        %>
            
        <script>
            function confirmarEliminacion(event, nombre) {
                if (!confirm("¿Estás seguro de eliminar la pintura llamada '" + nombre + "'?")) {
