...
<html>
    ...
    <%
        //obtenemos los datos de la pintura
        Pintura miPintura = (Pintura)request.getAttribute("MIPINTURA");
    %>
    <body>
            ...
            <form method="get" action="ServletPinturas">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" 
                       name="PINT_ID" id="PINT_ID" maxlength="8" 
                       value="<% out.print(miPintura.getPint_id()); %>" readonly>
              </div>
              
              <div class="form-group">
                <label for="PINT_NOMBRE">Nombre</label>
                <input type="text" class="form-control" 
                       name="PINT_NOMBRE" id="PINT_NOMBRE" 
                       value="<% out.print(miPintura.getPint_nombre()); %>" required>
              </div>
              
              <div class="form-group">
                <label for="PINT_FECHA">Fecha</label>
                <input type="date" class="form-control" 
                       name="PINT_FECHA" id="PINT_FECHA" 
                       value="<% out.print(miPintura.getPint_fecha()); %>" required>
              </div>
              
              <div class="form-group">
                <label for="PINT_VALOR">Valor Estimado</label>
                <input type="number" class="form-control"  
                       name="PINT_VALOR" id="PINT_VALOR" 
                       value="<% out.print(miPintura.getPint_valor()); %>" required>
              </div>
                ...
                <div class="form-group">
                    ...
                    <SELECT name="PIN_ID" class="custom-select">
                        <option value="<% out.print(miPintura.getPintor().getIdPintor()); %>"
                                ><% out.print(miPintura.getPintor().getPin_nombre()); %></option>
                        <%
                        ArrayList<Pintor> lstPintor = 
                                (ArrayList<Pintor>) request.getAttribute("TODOSLOSPINTORES");
                        
                        for(Pintor pintor : lstPintor ){
                ...
                <div class="form-group">
                    <label for="TEC_ID">Técnica:</label>
                    <SELECT name="TEC_ID" class="custom-select">
                        <option value="<% out.print(miPintura.getTecnica().getIdTecnica()); %>"
                                ><% out.print(miPintura.getTecnica().getDescripcion()); %></option>
                        <%
                        ArrayList<Tecnica> lstTecnica = 
                                (ArrayList<Tecnica>) request.getAttribute("TODASLASTECNICAS");
                        
                        for(Tecnica tecnica : lstTecnica ){
                             out.print("<option value='"
              ...
              <button type="submit" class="btn btn-info">Actualizar Pintura</button>
              
            </form>
            <div class="text-end">
                  <button onclick="window.history.back();" class="btn btn-primary">Regresar</button>
            </div>
        </div>
