...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/stylespinto.css">
    ...
    <body>
        ...
        <section class="centro">
            <div class="container mb-5">
                <div class="row">  
                    <div class="col">
                        <h1 style="Color:white">Lista de Pintores</h1>
                    </div>
                </div>
            </div>
            ...
            <%
                ...
                if (losPintores.size() != 0) {//si existen las técnicas entramos a la tabla
            %>
            <div class="container">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <%
                            for (Pintor pintor : losPintores) {
                                out.print("<tr>");
                                out.print("<td>" + pintor.getIdPintor() + "</td>");
                                out.print("<td>" + pintor.getPin_nombre() + "</td>");
                                out.print("<td>" + pintor.getPin_ciudad() + "</td>");
                                out.print("<td>" + pintor.getPin_fecha_nac() + "</td>");
                                out.print("<td>" + pintor.getPin_tel() + "</td>");
                                out.print("<td>" + pintor.getPin_email() + "</td>");
                                out.print("</tr>");
                            }
                        %>
                    </tbody>
